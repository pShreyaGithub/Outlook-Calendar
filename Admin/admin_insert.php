...
if (isset($_POST['fullname'], $_POST['email'], $_POST['phone'], $_POST['gender'], $_POST['password'])) {
    ...
    $emailquery = "SELECT * FROM admin_list WHERE email = '{$Email}'";
    ...
    if ($emailcount > 0) {
        ...
        if($Password) {
            $isql="INSERT INTO admin_list (fullname, email, phone, gender, password) VALUES ('$Fullname', '$Email', '$Phone', '$gender', '$pass')";
