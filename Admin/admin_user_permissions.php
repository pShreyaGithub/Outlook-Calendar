        ...
        <div class="first_user">
            <div class="container1">
                <div class="user button-container">
                    <h3>User List</h3>
                    <button class="button1" data-tooltips="Update" id="createUserBtn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
...
form.addEventListener('submit', function(event) {
    ...
    .then(data => {
        ...
        window.location.href = "admin_user_permissions.php";
    })
...
updateButtons.forEach(function(button) {
    button.addEventListener('click', function() {
        ...
        form.action = "admin_update_user.php";
        modal.style.display = "block";
    });
});
