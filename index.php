...
if(isset($_POST['signup'])) {
    ...
    if ($emailcount > 0) {
        ...
        if($Password === $Confpassword) {
            $isql="INSERT INTO registeration_form (fullname, email, phone, gender, password, conf_password) VALUES ('$Fullname', '$Email', '$Phone', '$gender', '$pass','$cpass')";
...
session_destroy(); // Destroy the session at the end
?>
...
if (isset($_POST['login'])) {
    ...
    $user_sql = "SELECT * FROM registeration_form WHERE email = '$email'";
    $user_result = mysqli_query($conn, $user_sql);
    $user_count = mysqli_num_rows($user_result);

    // Query to check if the email exists in the admin table
    $admin_sql = "SELECT * FROM administrator WHERE email = '$email'";
    ...
    if ($user_count) {
        ...
        // Verify if the hashed password matches the hashed password stored in the database
        ...
        // Email does not exist in the user or admin table
...
<body>
    <header id="navbar">
        <nav class="navbar" >
            ...
            <div class="buttons">
            <button class="btn btn signup" data-bs-toggle="modal" href="#exampleModalToggle" role="button">Sign in</button>
        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" id="login-form" method="POST" class="login-form">
                        ...
                        <div class="input-field">
                            ...
                            <span id="vaild-pass"></span>
                                ...
                                <br>        
                            <a href="forgotform.php" class="forgot-pass-link">Forgot password?</a>
